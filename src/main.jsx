...
import './index.css';
import Banner from '../src/sections/Banner.jsx';
import StepsComponent from './sections/Steps.jsx';

createRoot(document.getElementById('root')).render(
  <StrictMode>
    <img src="/sphere_main.svg" alt="" className='absolute top-[-14.5rem] left-[18.5rem] blur-[18px] w-[20rem] rotate-[-19deg]' />

    <nav className="flex items-center justify-center py-6">
      <div className="flex items-center justify-between w-full max-w-screen-xl">
        <img src="/icon-company.svg" className='w-[8rem]' alt="" />
    ...
    <img src="/sphere_main.svg" alt="" className='absolute bottom-[-11rem] right-[-9rem] blur-[18px] w-[20rem] rotate-[19deg]' />
      ...
      <div className='relative z-10 w-full max-w-screen-xl'>
        <div className='py-20 pt-32 text-center flex flex-col items-center justify-center gap-10  min-w-full md:flex-row lg:text-start'>
          <div className='flex flex-col gap-10 items-center justify-center  lg:items-start w-full max-w-[525px]'>
            ...
            <p className='font-thin max-w-[535px] mx-4 text-pretty'>
              Encargándonos de su sitio web, automatizando su negocio digital y
              guiando el proceso.
            </p>
            <div className='flex gap-3 items-center mx-4 w-fit justify-center text-xs flex-col md:items-start'>
              ...
              <p className='text-[#c4c4c4] text-xs'>
                Es un espacio en el plano digital para conectar con tus clientes
              </p>
            </div>
          </div>
        ...
        <div className='flex flex-col gap-3 md:flex-row'>
          <div className='w-full p-10 text-xs bg-[#150830] rounded-2xl md:w-1/2'>
            <p className='relative z-40'>
              Luztral surge con el propósito de guiar marcas en la manifestación
              de su portal digital para que puedan expandir su mensaje y
              conectar con su audiencia de forma genuina y poderosa en internet.
            </p>
          </div>
      ...
      <div className='flex flex-col gap-16 sm:flex-row sm:gap-0'>
        ...
        <div className='bg-service flex flex-col items-center justify-center gap-[14rem] relative w-full text-center overflow-hidden'>
          ...
          <div className='text-white mt-20 flex flex-col w-full items-center justify-center text-start gap-4 relative z-50'>
            ...
            <p className='text-sm font-extralight text-center max-w-[250px] sm:text-start'>
              Diseñamos marcas que conecten con tu propósito y vibren su propia
              esencia.{' '}
            </p>
          </div>
        </div>
        ...
        <div className='bg-service flex flex-col items-center justify-center gap-[14rem] relative w-full text-center overflow-hidden'>
          ...
          <div className='text-white mt-20 flex flex-col w-full items-center justify-center text-start gap-4 relative z-50'>
            ...
            <p className='text-sm font-extralight text-center max-w-[250px] sm:text-start'>
              Combinamos tecnología y diseño para crear sitios web que maximicen
              tus resultados.
            </p>
          </div>
        </div>
    ...
    {/* Background */}
      ...
      <div className='relative z-10 mx-5 text-white flex flex-col items-center justify-center gap-6'>
        ...
        <p className='text-center text-sm max-w-[750px]'>
           Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium quaerat voluptate facere et, quo saepe perspiciatis corporis similique.
        </p>
        <div className="flex items-center gap-20 mt-10 flex-col md:flex-row">

          <img src="/row.png" alt="" />
          <img src="/Mich.png" alt="" />
        </div>
    ...
    <section className='py-14 flex items-center justify-center'>
      <div className="text-white mx-5 flex flex-col items-center w-full justify-center gap-10 max-w-screen-xl">
        <div className="flex flex-col items-center justify-center gap-6 text-center md:flex-row md:justify-between w-full">
          ...
          <a href="" className='w-full px-5 py-2.5 rounded-4xl gradient-to-b  bg-gradient-to-b from-[#934bff] to-[#8941f7] md:w-fit '>
            Inciar un proyecto
          </a>
        </div>
